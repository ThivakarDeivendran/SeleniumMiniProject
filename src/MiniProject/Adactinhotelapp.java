...
public class Adactinhotelapp {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String bookingOrderNo= hotelbooking.findElement(By.xpath("//input[@id='order_no']")).getAttribute("value");
		System.out.println("Booking Order No   " +  bookingOrderNo);
		Thread.sleep(2000);
		hotelbooking.findElement(By.xpath("//input[@id='my_itinerary']")).click();
		Thread.sleep(2000);
		
		hotelbooking.findElement(By.xpath("//input[@id='order_id_text']")).sendKeys(bookingOrderNo);
		Thread.sleep(2000);
		hotelbooking.findElement(By.xpath("//*[@id='search_hotel_id']")).click();
		Thread.sleep(3000);
	...
	static void screenShotMethod() throws IOException {
		...
		File destinationfile= new File("D:\\User\\Document\\Eclipse_workspace\\SeleniumMiniProject\\ScreenShotFolder\\"+screenshotname);
